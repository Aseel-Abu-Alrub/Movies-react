...
export default function MovieDetails(){
  ...
  let{getMDetails,getVideo,getReviews,addRating,getSimilar}=useContext(MovieContext)
    ...
    const[vedio2,setVedio2]=useState([])
            ...
            <div className="movie__detail">
                ...
                <div className="movie__detailRight">
                    ...
                    <div className="movie__detailRightBottom">
                        ...
                        <Link target="_blank" className="text-white watch-btn position-relative" to={`https://www.youtube.com/watch?v=${vedio2.key}`}><i className='fa-solid fa-play position-absolute ms-4 mt-1 start-0 position-absolute'></i> Watch now</Link>
